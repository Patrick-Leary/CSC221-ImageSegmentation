...
public class Segment {
    ...
    public static void main(String[] args) throws IOException {
      Color[][] testArray = new Color[3][3];
      testArray[0][0] = Color.black;
      testArray[0][1] = Color.black;
      testArray[0][2] = Color.black;
      testArray[1][0] = Color.black;
      testArray[1][1] = Color.white;
      testArray[1][2] = Color.white;
      testArray[2][0] = Color.white;
      testArray[2][1] = Color.white;
      testArray[2][2] = Color.white;
